...
namespace PumpkinJourney.Video
{
    public class IntroVideoPlayer : MonoBehaviour
    {
        ...
        public string nextSceneName = "homePage";
    ...
    public float fadeDuration = 0.5f;
        ...
        void Start()
        {
            ...
            {
                Debug.LogError("❌ Intro VideoPlayer or VideoClip is missing!");
                LoadNextScene();
            }
        }
        ...
        {
            Debug.Log("✅ Intro video completed");
        ...
        void SkipIntro()
        {
            Debug.Log("⏭️ Intro video skipped by player");
            LoadNextScene();
        }
